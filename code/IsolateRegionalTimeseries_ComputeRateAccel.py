...
t0 = np.mean(t)     # solve rate at the this time
...
for n in range(Nbox):
    ...
    plt.scatter(t, sla_dszn[n,:], 3.5, color='red', marker='o', label='data')   # deseaoned timeseries data
    # plt.scatter(t, sla_[n,:], 3.5, color='red', marker='o', label='data')      # orig. timeseries data
